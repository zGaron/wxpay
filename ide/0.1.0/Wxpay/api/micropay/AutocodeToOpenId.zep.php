...
class AutocodeToOpenId extends \WXPay\Api
{
    ...
    protected $api_url = "https://api.mch.weixin.qq.com/tools/authcodetoopenid";
    ...
    protected $_either_groups = array("sign", "appid", "mch_id", "auth_code", "nonce_str", "sign");


    protected $_required_properties = array("appid", "mch_id", "auth_code", "nonce_str", "sign");
