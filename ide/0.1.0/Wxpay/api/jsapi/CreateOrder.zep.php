...
class CreateOrder extends \WXPay\Api
{
    ...
    protected $_required_properties = array("appid", "mch_id", "nonce_str", "sign", "body", "out_trade_no", "total_fee", "spbill_create_ip", "notify_url", "trade_type", "openid");


    protected $_optional_properties = array("device_info", "detail", "attach", "fee_type", "time_start", "time_expire", "goods_tag", "product_id", "limit_pay");
