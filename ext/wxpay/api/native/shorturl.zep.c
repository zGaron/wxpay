...
ZEPHIR_INIT_CLASS(WXPay_Api_Native_Shorturl) {
	...
	zend_declare_property_string(wxpay_api_native_shorturl_ce, SL("api_url"), "https://api.mch.weixin.qq.com/tools/shorturl", ZEND_ACC_PUBLIC TSRMLS_CC);

	zend_declare_property_bool(wxpay_api_native_shorturl_ce, SL("is_secure_pay"), 0, ZEND_ACC_PUBLIC TSRMLS_CC);
	 ...
	 */
	zend_declare_property_null(wxpay_api_native_shorturl_ce, SL("appid"), ZEND_ACC_PUBLIC TSRMLS_CC);
	 ...
	 * @see https://pay.weixin.qq.com/wiki/doc/api/native.php?chapter=9_9
	 */
	zend_declare_property_null(wxpay_api_native_shorturl_ce, SL("mch_id"), ZEND_ACC_PUBLIC TSRMLS_CC);
	 ...
	 * @see https://pay.weixin.qq.com/wiki/doc/api/native.php?chapter=9_9
	 */
	zend_declare_property_null(wxpay_api_native_shorturl_ce, SL("long_url"), ZEND_ACC_PUBLIC TSRMLS_CC);
	 ...
	 * @see https://pay.weixin.qq.com/wiki/doc/api/native.php?chapter=9_9
	 */
	zend_declare_property_null(wxpay_api_native_shorturl_ce, SL("nonce_str"), ZEND_ACC_PUBLIC TSRMLS_CC);
	 ...
	 * @see https://pay.weixin.qq.com/wiki/doc/api/native.php?chapter=9_9
	 */
	zend_declare_property_null(wxpay_api_native_shorturl_ce, SL("sign"), ZEND_ACC_PUBLIC TSRMLS_CC);

	zend_declare_property_null(wxpay_api_native_shorturl_ce, SL("_either_groups"), ZEND_ACC_PUBLIC TSRMLS_CC);

	zend_declare_property_null(wxpay_api_native_shorturl_ce, SL("_required_properties"), ZEND_ACC_PUBLIC TSRMLS_CC);

	zend_declare_property_null(wxpay_api_native_shorturl_ce, SL("_optional_properties"), ZEND_ACC_PUBLIC TSRMLS_CC);
