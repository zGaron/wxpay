...
ZEPHIR_INIT_CLASS(WXPay_Api_Jsapi_QueryOrder) {
	...
	zend_declare_property_string(wxpay_api_jsapi_queryorder_ce, SL("api_url"), "https://api.mch.weixin.qq.com/pay/orderquery", ZEND_ACC_PUBLIC TSRMLS_CC);

	zend_declare_property_bool(wxpay_api_jsapi_queryorder_ce, SL("is_secure_pay"), 0, ZEND_ACC_PUBLIC TSRMLS_CC);
	...
	zend_declare_property_null(wxpay_api_jsapi_queryorder_ce, SL("_either_groups"), ZEND_ACC_PUBLIC TSRMLS_CC);

	zend_declare_property_null(wxpay_api_jsapi_queryorder_ce, SL("_required_properties"), ZEND_ACC_PUBLIC TSRMLS_CC);

	zend_declare_property_null(wxpay_api_jsapi_queryorder_ce, SL("_optional_properties"), ZEND_ACC_PUBLIC TSRMLS_CC);
